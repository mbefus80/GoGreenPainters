...
SPECS = [
    ...
    ("og-blog-cedar-siding-paint-or-stain-grand-rapids.jpg", "exterior-after.jpg", "GO GREEN  ·  CEDAR SPECIALISTS",
     "Cedar Siding in Grand Rapids: Paint or Stain?"),
    ("og-blog-owner-operated-vs-college-painting-franchises-grand-rapids.jpg", "exterior-after.jpg", "GO GREEN  ·  OWNER-OPERATED",
     "Owner-Operated vs. College Painting Franchises in Grand Rapids"),
    ("og-blog-painting-stucco-brick-cedar-vinyl-grand-rapids.jpg", "exterior-after.jpg", "GO GREEN  ·  SIDING GUIDE",
     "Painting Stucco, Brick, Cedar, Vinyl & Fiber-Cement"),
    ("og-blog-affordable-painters-grand-rapids.jpg", "exterior-after.jpg", "GO GREEN  ·  HONEST PRICING",
